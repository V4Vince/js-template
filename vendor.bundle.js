...
/***/ function(module, exports, __webpack_require__) {
	...
	var storyData = __webpack_require__(4);
	...
	var promptUserLogin = function promptUserLogin(data) {
	  if (data === false) {
	...
	var populateTitles = function populateTitles(data) {
	  for (var i = 0; i < data.stories.length; i++) {
	    var storyTitle = data.stories[i].title;
	    var storyBody = data.stories[i].body;
	...
	var depopulateTitles = function depopulateTitles() {
	  $('.panel-title').remove();
	  $('.panel-body').remove();
	};
	...
	module.exports = {
	  ...
	  promptUserLogin: promptUserLogin,
	  hideAlert: hideAlert,
	  closeSignInModal: closeSignInModal,
	  showAlert: showAlert,
	  closeWriteStoryModal: closeWriteStoryModal,
	  closeSignUpModal: closeSignUpModal,
	  populateTitles: populateTitles,
	  depopulateTitles: depopulateTitles,
...
/***/ function(module, exports) {
	...
	var storyId = void 0;
	var storyToken = void 0;
	var allStories = void 0;
